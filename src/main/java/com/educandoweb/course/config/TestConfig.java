...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User u3 = new User(null, "Paulo Vilela", "paulo@teste.com", "123456743", "131313131" );
        ...
        Order o4 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"),OrderStatus.DELIVERED, u3);
        ...
        OrderItem oi5 = new OrderItem(o3, p1, 1, p1.getPrice());
